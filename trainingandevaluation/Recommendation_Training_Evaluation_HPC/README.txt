This script includes the necessary data and scripts for training and evaluating the models using the Snellius National Supercomputer.
...
The paths might need to be adapted and the correct email has to be set
Test around to find the appropriate values for partitions, time etc.
